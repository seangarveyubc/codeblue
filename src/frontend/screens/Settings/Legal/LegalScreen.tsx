        ...
        <ScrollView>
            ...
            <Text style={styles.bullet}>
                {'\u2022'} Application means the software program provided by the Company downloaded
                    by You on any electronic device, named CodeBlue
            </Text>
            <Text style={styles.bullet}>
                {'\u2022'} Company, referred to as either "the Company", "We", "Us" or "Our" in this
                    Agreement, refers to CodeBlue.
            </Text>
            <Text style={styles.bullet}>
            ...
            <Text style={styles.title}>Collecting and Using Your Personal Data</Text>
            ...
            <Text style={styles.subsubtitle}>Information Collected while Using the Application</Text>
            <Text style={styles.paragraph}>   
            ...
            <Text style={styles.paragraph}>If you have any questions about this Privacy Policy, You can contact us:
            </Text>
            <Text style={styles.bullet}>
                {'\u2022'} By email: cansave@ubc.ca
            </Text>
            <Text style={styles.bullet}>
                {'\u2022'} By visiting this page on our website: https://cansave.ubc.ca/
                </Text>
            <Text style={styles.lastbullet}>
                {'\u2022'} By mail: 4th floor, 1190 Hornby Street Vancouver, BC Canada
            </Text>
        </ScrollView>
    </View>
);
